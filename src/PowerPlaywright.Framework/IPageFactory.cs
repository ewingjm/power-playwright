namespace PowerPlaywright.Framework
{
    ...
    {
        /// <summary>
        /// Create an instance of a <see cref="IAppPage"/> from a page.
        /// </summary>
        /// <param name="page">The page.</param>
        /// <returns>The typed page.</returns>
        Task<IAppPage> CreateInstanceAsync(IPage page);

        /// <summary>
        /// Creates an instance of a <see cref="IAppPage"/> of type <typeparamref name="TPage"/>.
        /// </summary>
