namespace PowerPlaywright.IntegrationTests.Controls.Pcf
{
    ...
    public class IDateTests : IntegrationTests
    {
        ...
        /// <summary>
        /// Tests that <see cref="IDate.GetValueAsync()"/> returns the value when the record is inactive.
        /// </summary>
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Test]
        ...
        {
            var expectedValue = this.GetRandomDate();
            var dateControl = await this.SetupDateScenarioAsync(withValue: expectedValue, withDisabledRecord: true);
        ...
        private async Task<IDate> SetupDateScenarioAsync(DateTime? withValue = null, bool withNoValue = false, bool withDisabledRecord = false)
        {
