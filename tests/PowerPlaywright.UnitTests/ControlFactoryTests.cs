...
public class ControlFactoryTests
{
    ...
    /// <summary>
    /// Tests that the <see cref="ControlFactory.CreateInstance{TControl}(IAppPage, string, IControl, string)"/> method throws an <see cref="ArgumentNullException"/> when the appPage is null.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// /// Tests that the <see cref="ControlFactory.CreateInstance{TControl}(IAppPage, string, IControl, string)"/> method throws a <see cref="PowerPlaywrightException"/> when the strategyResolvers have not resolved the control type from the strategy assemblies.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that the <see cref="ControlFactory.CreateInstance{TControl}(IAppPage, string, IControl, string)"/> method creates an instance of the resolved control type when the strategyResolvers have resolved the control type from the strategy assemblies.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that the <see cref="ControlFactory.CreateInstance{TControl}(IAppPage, string, IControl, string)"/> method creates an instance of the redirected control type when the strategyResolvers have resolved the control type from the strategy assemblies and a control redirection is found for the control type in the strategy assemblies.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that the <see cref="ControlFactory.CreateInstance{TControl}(IAppPage, string, IControl, string)"/> method throws a <see cref="PowerPlaywrightException"/> when multiple redirectors are found for the control type in the strategy assemblies.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that the <see cref="ControlFactory.CreateInstance{TControl}(IAppPage, string, IControl, string)"/> method throws a <see cref="PowerPlaywrightException"/> when the strategyResolvers are not ready.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that the <see cref="ControlFactory.CreateInstance{TControl}(IAppPage, string, IControl, string)"/> method throws a <see cref="PowerPlaywrightException"/> when the control type is not found in the framework assembly.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that the <see cref="ControlFactory.CreateInstance{TControl}(IAppPage, string, IControl, string)"/> method passes the provided name as a constructor argument to the resolved control type.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that the <see cref="ControlFactory.CreateInstance{TControl}(IAppPage, string, IControl, string)"/> method passes the provided parent as a constructor argument to the resolved control type.
    /// </summary>
    [Test]
