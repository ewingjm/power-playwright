namespace PowerPlaywright.Strategies.Controls.Pcf
{
    ...
    public class PhoneNumberControl : PcfControlInternal, IPhoneNumberControl
    {
        ...
        public PhoneNumberControl(string name, IAppPage appPage, IEnvironmentInfoProvider infoProvider, IControl parent = null)
